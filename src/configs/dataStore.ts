import { hashData, hashString, keccakString } from "lib/hash";
...
export const MAX_POOL_USD_FOR_DEPOSIT_KEY = hashString(
...
export const CLAIMABLE_COLLATERAL_DELAY_KEY = hashString(
  "CLAIMABLE_COLLATERAL_DELAY"
);
export const CLAIMABLE_COLLATERAL_REDUCTION_FACTOR_KEY = hashString(
  "CLAIMABLE_COLLATERAL_REDUCTION_FACTOR"
);
export const CLAIMABLE_COLLATERAL_TIME_DIVISOR_KEY = hashString(
  "CLAIMABLE_COLLATERAL_TIME_DIVISOR"
);
export const MAX_LENDABLE_IMPACT_FACTOR_KEY = hashString(
  "MAX_LENDABLE_IMPACT_FACTOR"
);
export const MAX_LENDABLE_IMPACT_USD_KEY = hashString(
  "MAX_LENDABLE_IMPACT_USD"
);
export const MAX_LENDABLE_IMPACT_FACTOR_FOR_WITHDRAWALS_KEY = hashString(
  "MAX_LENDABLE_IMPACT_FACTOR_FOR_WITHDRAWALS"
);
export const LENT_POSITION_IMPACT_POOL_AMOUNT_KEY = hashString(
...
export const ESTIMATED_GAS_FEE_PER_ORACLE_PRICE = hashString(
...
export const ABOVE_OPTIMAL_USAGE_BORROWING_FACTOR = hashString(
...
export const GASLESS_FEATURE_DISABLED_KEY = hashString(
  "GASLESS_FEATURE_DISABLED"
);
export const GELATO_RELAY_FEE_MULTIPLIER_FACTOR_KEY = hashString(
  "GELATO_RELAY_FEE_MULTIPLIER_FACTOR"
);
export const REQUEST_EXPIRATION_TIME_KEY = hashString(
  "REQUEST_EXPIRATION_TIME"
);

export const GMX_SIMULATION_ORIGIN =
  "0x" + keccakString("GMX SIMULATION ORIGIN").slice(-40);
export const CLAIM_TERMS_KEY = hashString("CLAIM_TERMS");
export const GENERAL_CLAIM_FEATURE_DISABLED = hashString(
  "GENERAL_CLAIM_FEATURE_DISABLED"
);
export const USE_OPEN_INTEREST_IN_TOKENS_FOR_BALANCE = hashString(
  "USE_OPEN_INTEREST_IN_TOKENS_FOR_BALANCE"
);

export function subaccountExpiresAtKey(
  account: string,
  subaccount: string,
  actionType: string
) {
...
export function glvMaxMarketTokenBalanceUsdKey(
  glvAddress: string,
  market: string
) {
  return hashData(
...
export function glvMaxMarketTokenBalanceAmountKey(
  glvAddress: string,
  market: string
) {
  return hashData(
...
export function positionImpactExponentFactorKey(
  market: string,
  isPositive: boolean
) {
  return hashData(
...
export function subaccountIntegrationIdKey(
  account: string,
  subaccount: string
) {
  return hashData(
