...
import './tokens.js';
import { hashMarketConfigKeys } from './marketKeysAndConfigs.js';

// scripts/prebuild/prebuildMarketConfigKeys.ts
var MARKETS = {
  [ARBITRUM]: {
    // BTC/USD [WBTC.e-USDC]
...
function prebuildMarketConfigKeys(outputDir) {
  ...
  fs.writeFileSync(
    resolve(outputDir, "hashedMarketConfigKeys.json"),
    JSON.stringify(chainMarketKeys, null, 2)
  );
  return chainMarketKeys;
}

export { prebuildMarketConfigKeys };
//# sourceMappingURL=prebuildMarketConfigKeys.js.map
//# sourceMappingURL=prebuildMarketConfigKeys.js.map