import { getTotalSwapVolumeFromSwapStats } from '../executionFee/index.js';
import { getAmountByRatio } from '../swap/utils.js';
import { convertToTokenAmount, convertToUsd, getIsEquivalentTokens, getIsStake, getIsUnstake } from '../tokens/utils.js';
...
function getSwapAmountsByToValue(p) {
  ...
  if (isLimit) {
    ...
    if (allowedSwapSlippageBps !== void 0) {
...
export { getSwapAmountsByFromValue, getSwapAmountsByToValue, getSwapPathComparator };
//# sourceMappingURL=swapValues.js.map
//# sourceMappingURL=swapValues.js.map