...
import { getPositionFee } from '../executionFee/index.js';
import { OrderType } from '../orders/types.js';
import { getPositionPnlUsd, getLeverage, getMinCollateralFactorForPosition, getNetPriceImpactDeltaUsdForDecrease, getLiquidationPrice } from '../positions/utils.js';
import { getAcceptablePriceInfo, getDefaultAcceptablePriceImpactBps } from '../pricing/acceptablePrice.js';
import { getMarkPrice, getOrderThresholdType } from '../pricing/utils.js';
import { getSwapStats } from '../swap/swapStats.js';
import { getIsEquivalentTokens, convertToUsd, convertToTokenAmount } from '../tokens/utils.js';
import { bigMath } from '../../lib/bigmath/index.js';
import { applyFactor, roundUpDivision, getBasisPoints, BASIS_POINTS_DIVISOR_BIGINT, expandDecimals, USD_DECIMALS, MaxUint256 } from '../../lib/numbers/index.js';
...
function getDecreasePositionAmounts(p) {
  ...
  if (values.isFullClose) {
     ...
     */
    leverageWithoutPnl !== void 0 && leverageWithoutPnl !== 0n ? remainingCollateralUsd - bigMath.mulDiv(
      nextSizeInUsd,
