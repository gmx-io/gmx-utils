...
export declare function isNonZero<T extends number | bigint>(value: T): value is NonZero<T>;
export declare function safeDivide<T extends number | bigint>(a: T, b: NonZero<T>): T;
