...
export declare const EMPTY_BATCH_ORDER_PARAMS: BatchOrderTxnParams;
...
export declare function createCancelEncodedPayload(orderKeys?: (string | null)[]): string[];
export declare function createUpdateEncodedPayload({ chainId, orderKey, sizeDeltaUsd, executionFee, indexToken, acceptablePrice, triggerPrice, minOutputAmount, autoCancel, }: {
    chainId: ContractsChainId;
    orderKey: string;
    sizeDeltaUsd: bigint;
    executionFee?: bigint;
...
export declare function createDecreaseEncodedPayload({ chainId, orderVaultAddress, ps, uiFeeReceiver, }: {
    chainId: ContractsChainId;
